...
using VerifyCS = Architect.Build.SourceGenerator.UnitTests.Verifiers.CSharpSourceGeneratorVerifier<Architect.Build.SourceGenerator.BindableGenerator>;

namespace Architect.Build.SourceGenerator.UnitTests
{
    [TestClass]
    public class BindableGeneratorUnitTests
    {
...
{
	[global::System.CodeDom.Compiler.GeneratedCodeAttribute(""Architect.Build.SourceGenerator"", ""1.0.0.0"")]
...
";
            ...
            await VerifyCS.VerifyGeneratorAsync(
                code,
                diagnostics,
                ("HelloWorldAttribute.g.cs", Attribute)
            );
        }
...
";
            ...
            DiagnosticResult diagnostic = VerifyCS
                .Diagnostic("CS8795", DiagnosticSeverity.Error)
                .WithLocation(0)
            ...
            await VerifyCS.VerifyGeneratorAsync(
                ...
                diagnostic,
                ("HelloWorldAttribute.g.cs", Attribute),
                ("Greeter.HelloWorld.g.cs", generated)
            );
        }
